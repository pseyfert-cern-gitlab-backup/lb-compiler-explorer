...
RUN mkdir -p /usr/lib/llvm-9/lib/clang/9.0.1 \
    && ln -s /cvmfs/lhcb.cern.ch/lib/lcg/releases/clang/8.0.0-ed577/x86_64-centos7/lib/clang/8.0.0 /usr/lib/llvm-9/lib/clang/9.0.1/include
